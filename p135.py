...
print("Press 3 to check minimum out of 3 nos")
print("Press 4 to print table")
print("Press 5 to check factorial")
print("Press 7 to check oddeven")
print("Press 8 to check positive or negative")

option=int(input("Enter the value of the option"))
